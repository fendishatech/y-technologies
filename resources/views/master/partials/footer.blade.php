<footer class=" bg-gray-100 py-24">
    <div class="container mx-auto flex flex-col md:flex-row space-y-8 md:space-y-0 items-center justify-between">
        <a href="{{ url('home') }}">
        ...
        <p class="text-primary-500 text-2xl">© 2023 Y-Technologies. All rights reserved.</p>
    </div>
</footer>
