    ...
    <div class="w-full mb-2">
        <div class="flex flex-col items-start">
            ...
            <select name="material" class="w-full border rounded px-3 py-2 text-gray-700 focus:outline-none">
                <option value="Material One"
                    {{ old('material', $order->material) == 'Material One' ? 'selected' : '' }}>Material One
                </option>
                <option value="Material Two"
                    {{ old('material', $order->material) == 'Material Two' ? 'selected' : '' }}>Material Two
                </option>
            </select>
        </div>
    ...
    <div class="w-full mb-2">
        <div class="flex flex-col items-start">
            ...
            <select name="thickness" class="w-full border rounded px-3 py-2 text-gray-700 focus:outline-none">
                <option value="3" {{ old('thickness', $order->thickness) == '3' ? 'selected' : '' }}>3</option>
                <option value="6" {{ old('thickness', $order->thickness) == '6' ? 'selected' : '' }}>6</option>
                <option value="9" {{ old('thickness', $order->thickness) == '9' ? 'selected' : '' }}>9</option>
            </select>
        </div>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-x-6">
    ...
    <div class="w-full mb-2">
        {{-- @if ($order->design_img != null) --}}
        <img id="imagePreview" class=""
            src="{{ $order->design_img != null ? asset('storage/' . $order->design_img) : '#' }}" alt="Design File">
        {{-- @else
